...
if TYPE_CHECKING:
    from eb_shape.morphisms.reactive import (
        OnChangeOp,
        OnChildChangeOp,
        OnChildrenChangeOp,
...
class PrimitiveObservableBase:
    ...
    def on_change(self) -> OnPrimitiveChangeOp:
        from eb_shape.morphisms.reactive import OnPrimitiveChangeOp
