"""everyservice -- Service substrate for everybase.
...
return lazy Value terms that compose with everyshape terms and flows.

Architecture::

    everybase (core: Term, Flow, Context, Span)
    +-- everyshape     -- document-model substrate (Ref -> nested data navigation)
    +-- everyservice   -- service substrate (Interface -> method terms)
"""
