...
from term.types import DictType, NoneType, TupleType

from every._abc import Term, computed, literal
...
if TYPE_CHECKING:
    ...
    from term.types import BoolType, BytesType, FloatType, IntType, ListType, SetType, StrType
