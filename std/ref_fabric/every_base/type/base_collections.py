...
if TYPE_CHECKING:
    ...
    from term.types import BoolType, DictType, FloatType, IntType, ListType, StrType

    from every._abc import BoolArg, IntArg, StrArg, Term
...
class ContainableBase[ItemT]:
    ...
    def contains(self, item: ItemT) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from term.ops import ContainsOp
...
class SequenceBase[ElementT, ResultT](
    ...
    def reversed_(self) -> ResultT:
        ...
        Returns:
            Reversed sequence
        """
        from term.ops import ReversedOp
    ...
    def index(self, value: ElementT) -> IntType:
        ...
        Returns:
            Index
        """
        from term.ops import IndexOfOp
        from term.types import IntType
    ...
    def find_index(self, predicate: Callable[[ElementT], bool]) -> IntType:
        ...
        """
        from term.ops import FindIndexOp
        from term.types import IntType
...
class MappingBase[KeyT, ValueT, ResultT](
    ...
    def keys_(self) -> ResultT:
        ...
        Returns:
            Keys sequence
        """
        from term.types.dict_ops import DictKeysOp
    ...
    def values_(self) -> ResultT:
        ...
        Returns:
            Values sequence
        """
        from term.types.dict_ops import DictValuesOp
    ...
    def items_(self) -> ResultT:
        ...
        Returns:
            Items sequence
        """
        from term.types.dict_ops import DictItemsOp
    ...
    def get_(self, key: KeyT, default: ValueT | None = None) -> ResultT:
        ...
        Returns:
            Value or default
        """
        from term.types.dict_ops import DictGetOp
...
class SetBase[ElementT, ResultT](
    ...
    def union(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Union set
        """
        from term.types.set_ops import UnionOp
    ...
    def intersection(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Intersection set
        """
        from term.types.set_ops import IntersectionOp
    ...
    def difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Difference set
        """
        from term.types.set_ops import DifferenceOp
    ...
    def symmetric_difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        """
        from term.types.set_ops import SymmetricDifferenceOp
    ...
    def issubset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from term.types import BoolType
        from term.types.set_ops import IsSubsetOp
    ...
    def issuperset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from term.types import BoolType
        from term.types.set_ops import IsSupersetOp
    ...
    def isdisjoint(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from term.types import BoolType
        from term.types.set_ops import IsDisjointOp
