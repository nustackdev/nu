...
if TYPE_CHECKING:
    ...
    from nustd.uuid.forms import UUIDArg
...
def uuid4() -> UUID:
    ...
    from nustd.uuid.interactions import Uuid4Query
...
def uuid1(node: IntArg | None = None, clock_seq: IntArg | None = None) -> UUID:
    ...
    from nustd.uuid.interactions import Uuid1Query
...
def uuid3(namespace: UUIDArg, name: StrArg) -> UUID:
    ...
    from nustd.uuid.interactions import Uuid3Query
...
def uuid5(namespace: UUIDArg, name: StrArg) -> UUID:
    ...
    from nustd.uuid.interactions import Uuid5Query
