...
:class:`~nu.engine.structure.term.TermMeta`. Tree-wide attributes -- defaults
...
:class:`~nu.engine.structure.exceptions.CycleError`; using a non-finalized
schema raises :class:`~nu.engine.structure.exceptions.NotFinalizedError`.
...
class Schema:
    ...
    def finalize(self) -> Schema:
        ...
        """
        from nu.engine.structure.attribute import Computed
