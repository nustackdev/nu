...
class TestPathSetAndGet:
    ...
    async def test_set_and_get_path(self, path_shape, ctx):
        ...
        await path_shape.config_path.set(p).execute(ctx)
        result = await path_shape.config_path.get().execute(ctx)
        assert result == p

    async def test_set_path_from_string(self, path_shape, ctx):
        """Set path from string."""
        await path_shape.config_path.set("/home/user/file.txt").execute(ctx)
        result = await path_shape.config_path.get().execute(ctx)
    ...
    async def test_set_multiple_paths(self, path_shape, ctx):
        ...
        await path_shape.config_path.set(config).execute(ctx)
        await path_shape.data_dir.set(data).execute(ctx)

        assert await path_shape.config_path.get().execute(ctx) == config
        assert await path_shape.data_dir.get().execute(ctx) == data
...
class TestPathComponentAccess:
    ...
    async def test_parent(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        await path_shape.config_path.set(p).execute(ctx)
        result = await path_shape.config_path.get().parent().execute(ctx)
    ...
    async def test_parts(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        await path_shape.config_path.set(p).execute(ctx)
        result = await path_shape.config_path.get().parts().execute(ctx)
    ...
    async def test_root(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        await path_shape.config_path.set(p).execute(ctx)
        assert await path_shape.config_path.get().root().execute(ctx) == "/"

    async def test_anchor(self, path_shape, ctx):
        """Access path anchor."""
        p = Path("/home/user/file.txt")
        await path_shape.config_path.set(p).execute(ctx)
        assert await path_shape.config_path.get().anchor().execute(ctx) == "/"
...
class TestPathManipulation:
    ...
    async def test_truediv_join(self, path_shape, ctx):
        ...
        p = Path("/home/user")
        await path_shape.data_dir.set(p).execute(ctx)

        result = await (path_shape.data_dir.get() / "subdir").execute(ctx)
    ...
    async def test_joinpath(self, path_shape, ctx):
        ...
        result = await path_shape.data_dir.get().joinpath("subdir", "file.txt").execute(ctx)
    ...
    async def test_with_name(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().with_name("other.txt").execute(ctx)
    ...
    async def test_with_stem(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().with_stem("other").execute(ctx)
        assert result == Path("/home/user/other.txt")
    ...
    async def test_with_suffix(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().with_suffix(".md").execute(ctx)
    ...
    async def test_relative_to(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().relative_to("/home/user").execute(ctx)
...
class TestPathTests:
    ...
    async def test_is_absolute_true(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().is_absolute().execute(ctx)
    ...
    async def test_is_relative_to_true(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().is_relative_to("/home").execute(ctx)
        assert result is True
    ...
    async def test_match_true(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().match("*.txt").execute(ctx)
        assert result is True
    ...
    async def test_match_false(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().match("*.py").execute(ctx)
        assert result is False
...
class TestPathConversions:
    ...
    async def test_as_posix(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().as_posix().execute(ctx)
        assert result == "/home/user/file.txt"
    ...
    async def test_as_uri(self, path_shape, ctx):
        ...
        result = await path_shape.config_path.get().as_uri().execute(ctx)
...
class TestPathEquality:
    ...
    async def test_equals(self, path_shape, ctx):
        ...
        await path_shape.config_path.set(Path("/home/user")).execute(ctx)
        await path_shape.data_dir.set(Path("/home/user")).execute(ctx)

        result = await path_shape.config_path.get().eq(path_shape.data_dir.get()).execute(ctx)
        assert result is True

    async def test_not_equals(self, path_shape, ctx):
        """Compare paths for inequality."""
        await path_shape.config_path.set(Path("/home/user")).execute(ctx)
        await path_shape.data_dir.set(Path("/var/log")).execute(ctx)

        result = await path_shape.config_path.get().ne(path_shape.data_dir.get()).execute(ctx)
        assert result is True
