"""RPyC server service for hosting EveryFlow resources remotely.

This module provides thin server services that leverage EveryFlow's resource system
...
import attrs
from everylink import ResourceSpec, SyncResource
...
class RPyCUnixServer(BaseRPyCServer, SyncResource):
...
class RPyCUnixServerSpec(ResourceSpec):
    ...
    socket_path: str = "/tmp/everyflow_rpyc.sock"
