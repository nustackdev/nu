...
import attrs
from everylink import ResourceSpec, Spec
...
class MultiprocessingLauncher(BaseLauncher):
    ...
    Examples:
        ...
        >>> from pl.rpc.rpyc import RPyCUnixServerSpec
    ...
    def _start_host(self) -> None:
        ...
        try:
            ...
            try:
                ...
                raise ProcessTimeoutError(error_msg) from None
...
class MultiprocessingLauncherSpec(ResourceSpec):
    ...
    Examples:
        ...
        TCP RPyC server:
        >>> from pl.rpc.rpyc import RPyCTCPServerSpec
        >>> spec = MultiprocessingLauncherSpec(
        ...     host=RPyCTCPServerSpec(host="localhost", port=18861),
        ...     startup_timeout=15.0,
        ...     process_timeout=60.0,
        ...
        >>> spec = MultiprocessingLauncherSpec(
        ...     host=RPyCUnixServerSpec(socket_path="/tmp/service.sock"),
        ...     config={"daemon": False, "name": "everyflow_worker"},
        ... )
    """
