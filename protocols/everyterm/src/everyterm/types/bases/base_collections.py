...
if TYPE_CHECKING:
    ...
    from everyterm.term import BoolArg, IntArg, StrArg, Term
    from everyterm.types import BoolType, DictType, FloatType, IntType, ListType, StrType
...
class LengthableBase:
    ...
    def len_(self) -> IntType:
        ...
        Returns:
            Length value
        """
        from everyterm.ops import LenOp
        from everyterm.types import IntType
...
class IndexableBase[KeyT, ResultValue]:
    ...
    def __getitem__(self, key: KeyT) -> ResultValue:
        ...
        from everyterm.ops import AtOp
...
class SliceableBase[ResultT]:
    ...
    def slice_(
        ...
        Returns:
            Sliced result
        """
        from everyterm.ops import SliceOp
...
class ContainableBase[ItemT]:
    ...
    def contains(self, item: ItemT) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everyterm.ops import ContainsOp
        from everyterm.types import BoolType
...
class IterableBase[ElementT, ResultT]:
    ...
    def map_[R](self, func: Callable[[ElementT], R]) -> ResultT:
        ...
        Returns:
            Mapped result
        """
        from everyterm.ops import MapOp
    ...
    def filter_(self, predicate: Callable[[ElementT], bool]) -> ResultT:
        ...
        Returns:
            Filtered result
        """
        from everyterm.ops import FilterOp
    ...
    def reduce_[R](self, func: Callable[[R, ElementT], R], initial: R) -> object:
        ...
        Returns:
            Reduced value
        """
        from everyterm.ops import ReduceOp
        from everyterm.types import AnyType
    ...
    def sum_(self) -> ResultT:
        ...
        Returns:
            Sum
        """
        from everyterm.ops import SumOp
    ...
    def min_(self) -> ResultT:
        ...
        Returns:
            Minimum
        """
        from everyterm.ops import MinOp
    ...
    def max_(self) -> ResultT:
        ...
        Returns:
            Maximum
        """
        from everyterm.ops import MaxOp
    ...
    def any_(self) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everyterm.ops import AnyOp
        from everyterm.types import BoolType
    ...
    def all_(self) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everyterm.ops import AllOp
        from everyterm.types import BoolType
...
class SequenceBase[ElementT, ResultT](
    ...
    def first(self) -> ResultT:
        ...
        Returns:
            First element
        """
        from everyterm.ops import FirstOp
    ...
    def last(self) -> ResultT:
        ...
        Returns:
            Last element
        """
        from everyterm.ops import LastOp
    ...
    def reversed_(self) -> ResultT:
        ...
        Returns:
            Reversed sequence
        """
        from everyterm.ops import ReversedOp
    ...
    def sorted_(self, reverse: BoolArg = False) -> ResultT:
        ...
        Returns:
            Sorted sequence
        """
        from everyterm.ops import SortedOp
    ...
    def join(self, separator: StrArg) -> StrType:
        ...
        Returns:
            Joined string
        """
        from everyterm.ops import JoinOp
    ...
    def index(self, value: ElementT) -> IntType:
        ...
        Returns:
            Index
        """
        from everyterm.ops import IndexOfOp
        from everyterm.types import IntType
    ...
    def find_index(self, predicate: Callable[[ElementT], bool]) -> IntType:
        ...
        """
        from everyterm.ops import FindIndexOp
        from everyterm.types import IntType
    ...
    def count(self, value: ElementT) -> IntType:
        ...
        Returns:
            Count
        """
        from everyterm.ops import CountOp
        from everyterm.types import IntType
...
class MappingBase[KeyT, ValueT, ResultT](
    ...
    def keys_(self) -> ResultT:
        ...
        Returns:
            Keys sequence
        """
        from everyterm.types.dict_ops import DictKeysOp
    ...
    def values_(self) -> ResultT:
        ...
        Returns:
            Values sequence
        """
        from everyterm.types.dict_ops import DictValuesOp
    ...
    def items_(self) -> ResultT:
        ...
        Returns:
            Items sequence
        """
        from everyterm.types.dict_ops import DictItemsOp
    ...
    def get_(self, key: KeyT, default: ValueT | None = None) -> ResultT:
        ...
        Returns:
            Value or default
        """
        from everyterm.types.dict_ops import DictGetOp
...
class SetBase[ElementT, ResultT](
    ...
    def union(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Union set
        """
        from everyterm.types.set_ops import UnionOp
    ...
    def intersection(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Intersection set
        """
        from everyterm.types.set_ops import IntersectionOp
    ...
    def difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Difference set
        """
        from everyterm.types.set_ops import DifferenceOp
    ...
    def symmetric_difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        """
        from everyterm.types.set_ops import SymmetricDifferenceOp
    ...
    def issubset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everyterm.types import BoolType
        from everyterm.types.set_ops import IsSubsetOp
    ...
    def issuperset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everyterm.types import BoolType
        from everyterm.types.set_ops import IsSupersetOp
    ...
    def isdisjoint(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everyterm.types import BoolType
        from everyterm.types.set_ops import IsDisjointOp
