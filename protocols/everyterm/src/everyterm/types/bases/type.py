...
from everyterm.term import Type


if TYPE_CHECKING:
    from everyterm.term import BoolArg, StrArg, Term
    from everyterm.types import AnyType, BoolType, BytesType, FloatType, IntType, ListType, StrType
...
class BaseType[T](Type[T]):
    ...
    def is_empty(self) -> BoolType:
        ...
        """
        from everyterm.ops import IsEmptyOp
    ...
    def is_invalid(self) -> BoolType:
        ...
        Returns:
            BoolType-like result
        """
        from everyterm.ops import IsNaNOp
        from everyterm.types import BoolType
    ...
    def ifelse[ElseT](
        ...
        """
        from everyterm.ops import ConditionalOp
    ...
    def to_int(self) -> IntType:
        ...
        """
        from everyterm.ops import ToIntOp
    ...
    def to_float(self) -> FloatType:
        ...
        """
        from everyterm.ops import ToFloatOp
        from everyterm.types import FloatType
    ...
    def to_bool(self) -> BoolType:
        ...
        """
        from everyterm.ops import ToBoolOp
        from everyterm.types import BoolType
    ...
    def to_str(self) -> StrType:
        ...
        """
        from everyterm.ops import ToStrOp
    ...
    def to_bytes(self, encoding: StrArg = "utf-8") -> BytesType:
        ...
        """
        from everyterm.ops import ToBytesOp
        from everyterm.types import BytesType
    ...
    def to_list(self) -> ListType:
        ...
        """
        from everyterm.ops import ToListOp
