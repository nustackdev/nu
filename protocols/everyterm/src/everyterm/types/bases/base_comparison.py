...
class OrderableBase[OperandT]:
    ...
    def __gt__(self, other: OperandT) -> BoolType:
        ...
        from everyterm.ops import GtOp
        from everyterm.types import BoolType
    ...
    def __lt__(self, other: OperandT) -> BoolType:
        ...
        from everyterm.ops import LtOp
        from everyterm.types import BoolType
    ...
    def __ge__(self, other: OperandT) -> BoolType:
        ...
        from everyterm.ops import GeOp
        from everyterm.types import BoolType
    ...
    def __le__(self, other: OperandT) -> BoolType:
        ...
        from everyterm.ops import LeOp
        from everyterm.types import BoolType
...
class EqualableBase[OperandT]:
    ...
    def eq(self, other: OperandT) -> BoolType:
        ...
        Returns:
            Comparison result
        """
        from everyterm.ops import EqOp
        from everyterm.types import BoolType
    ...
    def ne(self, other: OperandT) -> BoolType:
        ...
        Returns:
            Comparison result
        """
        from everyterm.ops import NeOp
        from everyterm.types import BoolType
    ...
    def is_(self, other: OperandT) -> BoolType:
        ...
        Returns:
            IdCompOp expression
        """
        from everyterm.ops import IdCompOp
        from everyterm.types import BoolType
