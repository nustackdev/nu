...
Walks the term tree bottom-up. For each op node that holds a virtuals
...
def _try_inline_ref(node: object) -> object:
    ...
    # virtuals path: ((addr, type_marker), ...)
