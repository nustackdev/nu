...
Substrate plug-points (``afetch_parent``, ``aresolve_address``) carry v2
...
v1 reference: ``src/nu/shapes/refs/base.py``.
"""
...
class _StructuredRef(Ref):
    ...
    def _primitive_write(self, rt: Runtime, value: object, nid_self: int) -> None:
        ...
        v1 reference: ``src/nu/shapes/refs/base.py`` — ``parent._primitive_write``.
        """
    ...
    def coerce(self, raw: object) -> object:
        ...
        v1 reference: ``src/nu/shapes/refs/base.py::Ref.coerce``.
        """
        return raw
