...
v1 reference: ``src/nu/shapes/refs/shape.py``.
Deviations from v1:
- MutableShapeRef / ReactiveShapeRef are added (v1 had these, v2 port had dropped them).
...
from nu2.domains.shape.forms.mapping import MappingForm, MutableMappingForm, ReactiveMappingForm

from .base import _StructuredRef


if TYPE_CHECKING:
    from nu2.domains.shape.dsl import Shape, Slot
