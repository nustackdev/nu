...
v1 reference: ``src/nu/shapes/flows/stream.py``.
"""
...
from nu2.domains.shape.interactions import AdvanceCursorQuery, OnChildrenChangeQuery
...
class Stream(StreamQuery):
    ...
    def __init__(
        ...
        *,
        ...
        from nu2.context.refs import AttrRef
