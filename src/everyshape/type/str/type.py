...
from everyshape.term.type import (
    AddableBase,
    ComparisonBase,
    ContainableBase,
    LengthableBase,
...
class StrType(
    ...
    def strip(self, chars: str | Term | None = None) -> StrType:
        ...
        from everyshape.type.str.ops import StripOp
    ...
    def lstrip(self, chars: str | Term | None = None) -> StrType:
        ...
        from everyshape.type.str.ops import LStripOp
    ...
    def rstrip(self, chars: str | Term | None = None) -> StrType:
        ...
        from everyshape.type.str.ops import RStripOp
    ...
    def split(self, sep: str | Term | None = None, maxsplit: int = -1) -> ListType[str]:
        """Split string."""
        from everyshape.type.str.ops import SplitOp
    ...
    def rsplit(self, sep: str | Term | None = None, maxsplit: int = -1) -> ListType[str]:
        """Right split string."""
        from everyshape.type.str.ops import RSplitOp
    ...
    def find(self, sub: str | Term, start: int = 0, end: int | None = None) -> IntType:
        """Find substring."""
        from everyshape.type.str.ops import FindOp
    ...
    def rfind(self, sub: str | Term, start: int = 0, end: int | None = None) -> IntType:
        ...
        from everyshape.type.str.ops import RFindOp
    ...
    def count_substring(self, sub: str | Term) -> IntType:
        ...
        from everyshape.type.str.ops import CountSubstringOp
    ...
    def startswith(self, prefix: str | Term) -> BoolType:
        ...
        from everyshape.type.str.ops import StartsWithOp
    ...
    def endswith(self, suffix: str | Term) -> BoolType:
        ...
        from everyshape.type.str.ops import EndsWithOp
    ...
    def isdigit(self) -> BoolType:
        """Check if all digits."""
        from everyshape.type.str.ops import IsDigitOp
    ...
    def isalpha(self) -> BoolType:
        ...
        from everyshape.type.str.ops import IsAlphaOp
    ...
    def isalnum(self) -> BoolType:
        ...
        from everyshape.type.str.ops import IsAlnumOp
    ...
    def isspace(self) -> BoolType:
        ...
        from everyshape.type.str.ops import IsSpaceOp
    ...
    def center(self, width: int | Term, fillchar: str = " ") -> StrType:
        """Center in width."""
        from everyshape.type.str.ops import CenterOp
    ...
    def ljust(self, width: int | Term, fillchar: str = " ") -> StrType:
        """Left justify."""
        from everyshape.type.str.ops import LJustOp
    ...
    def replace(self, old: str | Term, new: str | Term, count: int = -1) -> StrType:
        """Replace substring."""
        from everyshape.type.str.ops import ReplaceOp
    ...
    def encode(self, encoding: str = "utf-8") -> BytesType:
        ...
        from everyshape.type.str.ops import EncodeOp
