...
class BytesType(
    ...
    def decode(self, encoding: str = "utf-8") -> StrType:
        ...
        from everyshape.type.bytes.ops import DecodeOp
    ...
    def hex_(self) -> StrType:
        ...
        from everyshape.type.bytes.ops import HexOp
    ...
    def upper(self) -> BytesType:
        ...
        from everyshape.type.bytes.ops import BytesUpperOp

        return cast("BytesType", self._wrap_bytes_result(BytesUpperOp(self)))

    def lower(self) -> BytesType:
        """Convert to lowercase."""
        from everyshape.type.bytes.ops import BytesLowerOp
    ...
    def strip(self, chars: bytes | Term | None = None) -> BytesType:
        ...
        from everyshape.type.bytes.ops import BytesStripOp
    ...
    def lstrip(self, chars: bytes | Term | None = None) -> BytesType:
        ...
        from everyshape.type.bytes.ops import BytesLStripOp
    ...
    def rstrip(self, chars: bytes | Term | None = None) -> BytesType:
        ...
        from everyshape.type.bytes.ops import BytesRStripOp
    ...
    def split_bytes(self, sep: bytes | Term | None = None, maxsplit: int = -1) -> ListType[bytes]:
        """Split bytes."""
        from everyshape.type.bytes.ops import BytesSplitOp
    ...
    def find_bytes(self, sub: bytes | Term, start: int = 0, end: int | None = None) -> IntType:
        """Find sub-bytes."""
        from everyshape.type.bytes.ops import BytesFindOp
    ...
    def count_bytes(self, sub: bytes | Term) -> IntType:
        ...
        from everyshape.type.bytes.ops import BytesCountOp
    ...
    def startswith(self, prefix: bytes | Term) -> BoolType:
        ...
        from everyshape.type.bytes.ops import BytesStartsWithOp
    ...
    def endswith(self, suffix: bytes | Term) -> BoolType:
        ...
        from everyshape.type.bytes.ops import BytesEndsWithOp
    ...
    def replace(self, old: bytes | Term, new: bytes | Term, count: int = -1) -> BytesType:
        """Replace sub-bytes."""
        from everyshape.type.bytes.ops import BytesReplaceOp
