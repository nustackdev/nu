...
navigation system from everyshape.loc.path.
"""
...
from everyshape.shape import PrimitiveRefBase, Ref, RValue, Shape, ViewRefBase, literal
...
if TYPE_CHECKING:
    ...
    from everyshape.shape import RValue, Shape
    from everyshape.types import MutableMapping, MutableSequence
