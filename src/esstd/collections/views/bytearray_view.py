...
from everyshape.types import is_empty
from everyshape.view import MetadataBasedChildrenCountMixin, WatchMixin
...
if TYPE_CHECKING:
    ...
    from everyshape.types import Assignable, Convertible, Initializable, Subscriptable
