...
interface for containers implementing FIFO semantics.

TODO: upgrade to match the current View API.
"""
...
# from everyshape.tree import View
# from everyshape.view.registry import ComponentConstructor, ContainerConstructor
# from everyshape.tree.types import ContainerProtocol, ContainerStructure


# if TYPE_CHECKING:
#     from collections.abc import Generator

#     from everyshape.abc import Value
