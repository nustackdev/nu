...
The sentinel-check helpers and ``BoolForm`` they return live in ``nu.forms``;
...
class Form:
    ...
    def is_empty(self) -> BoolForm:
        ...
        from nu.core import IsEmptyQuery
        from nu.forms import BoolForm
    ...
    def is_invalid(self) -> BoolForm:
        ...
        from nu.core import IsInvalidQuery
        from nu.forms import BoolForm
