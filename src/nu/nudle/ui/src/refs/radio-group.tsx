...
function normalizeOrientation(raw: unknown): Orientation {
...
function RadioGroupView({ path }: { path: string }) {
...
export const RadioGroupRef: RefEntry = { factory, component: RadioGroupView };
