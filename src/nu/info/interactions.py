...
from nu.info.form import parse_form
from nu.info.interaction import parse_interaction
from nu.info.ref import parse_ref
...
if TYPE_CHECKING:
    ...
    from nu.info.call import CallRecord
    from nu.info.interaction import InteractionRecord
...
class Inspect(ScalarQuery):
    ...
    Yields:
        ...
        nu.info can describe.

    Example:
        >>> nu.run(nu.info.Inspect("nu.core.arithmetic"))[0].splitlines()[0]
...
def _render_module(module: ModuleType) -> str:
    from nu.info.form import catalogue as forms_of
    from nu.info.interaction import catalogue as interactions_of
    from nu.info.ref import catalogue as refs_of
