...
class ShapeRef[T: ShapeBase](
    Ref[dict[str, object]],
    MappingForm[str, object, object, object],
):
    ...
    ops (keys, values, items, get, extract, exists, etc.) from MappingForm.
    ...
    Ref, MappingForm, etc. resolve via normal MRO first. Only names not
...
class MutableShapeRef[T: ShapeBase](
    ShapeRef[T],
    MutableMappingForm[str, object, object, object],
):
