...
from nu.interfaces.collections_abc import MappingBase as _EB_MappingBase
from nu.interfaces.collections_abc import MutableMappingBase as _EB_MutableMappingBase
