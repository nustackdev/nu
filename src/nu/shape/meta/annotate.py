...
def annotate_ref_loads[N: Node](root: N) -> N:
    ...
    """
    from nu.shape.collections.items import ItemBase
    from nu.shape.morphisms.collection import CollectionLoadOp
    from nu.shape.morphisms.item import ItemLoadOp
    from nu.shape.refs.base import Ref as ShapeRef
