...
if TYPE_CHECKING:
    ...
    from nu.shape.morphisms.reactive import (
        OnChangeOp,
        OnChildChangeOp,
        OnChildrenChangeOp,
...
class PrimitiveObservableBase:
    ...
    def on_change(self) -> OnPrimitiveChangeOp:
        from nu.shape.morphisms.reactive import OnPrimitiveChangeOp
