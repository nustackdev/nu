...
from everykv.loc.constants import METADATA_ROOT
from everykv.typing import EMPTY
...
if TYPE_CHECKING:
    ...
    from everykv.storage import StorageContextType
    from everykv.typing import Empty, Value
...
def iter_metadata_keys(
    ...
    Raises:
        StorageInterfaceError: If context doesn't support reads
    """
    from everykv.storage import LengthFilter, PrefixFilter, StorageScanOptions
