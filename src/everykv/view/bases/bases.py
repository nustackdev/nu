...
from everykv.container import Container, ContainerStructure, NodeType, node_ops
from everykv.typing import Empty, Value, is_empty


if TYPE_CHECKING:
    from everykv.container.types import NodeInfo
    from everykv.loc import site as site_
    from everykv.view import View, ViewRegistry
...
class ChildNestedGetBase:
    ...
    def _extract_child_container(
        ...
        *,
        ...
        """
        from everykv.typing.view import Convertible
...
class ChildNestedSetBase:
    ...
    def _populate_child_container(self, address: site_.SiteSegment, value: object) -> None:
        ...
        """
        from everykv.typing.view import Initializable
