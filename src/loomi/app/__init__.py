...
class AppBase(ABC, Generic[StateT, EvaluatorT, LoggerT]):
    """
    ...
    @property
    def ev(self) -> EvaluatorT:
        """Short alias for evaluator."""
...
class SyncApp(
    AppBase["SyncStateProtocol", "SyncEvaluatorProtocol", "SyncLoggerProtocol"], SyncResource
):
    """
    ...
    def start(self, context=None) -> None:
        ...
        self.evaluator.execute(operation, context)
