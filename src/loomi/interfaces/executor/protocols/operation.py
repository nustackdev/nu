...
class SyncOperationProtocol(Protocol[ContextT_contra]):
    """
    Protocol defining the interface for all operations.
    ...
    @property
    def children(self) -> tuple["SyncOperationProtocol[ContextT_contra]", ...]:
        """
        Get all child operations of this operation.
    ...
    def execute(self, context: "ContextT_contra") -> None:
        """
        Execute the operation within the given context.
