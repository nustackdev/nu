...
class Loop(Expression):
    ...
    def __init__(
        ...
        /,
        *,
        condition: Optional[Callable[[Context], Awaitable[bool] | bool]] = None,
        condition_path: Optional[Tuple[str, ...] | str] = None,
        max_iterations: Optional[int] = None,
        on_finish: Optional[Expression] = None,
    ...
    @property
    def condition(self) -> Optional[Callable[[Context], Awaitable[bool] | bool]]:
        """
    ...
    @property
    def on_finish(self) -> Optional[Expression]:
        """
