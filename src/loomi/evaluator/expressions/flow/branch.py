...
class Branch(Expression):
    ...
    def __init__(
        self,
        exprs: Dict[BranchConditionValue, Expression],
        /,
        *,
        condition: Optional[Callable[[Context], Awaitable[Any] | Any]] = None,
    ...
    @property
    def branch_exprs(self) -> Dict[BranchConditionValue, Expression]:
        """
    ...
    @property
    def condition(self) -> Optional[Callable[[Context], Awaitable[Any] | Any]]:
        """
