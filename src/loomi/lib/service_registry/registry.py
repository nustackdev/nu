...
from loomi.service.types import ServiceState

from .exceptions import RegistryError, RegistryKeyError, RegistryStateError
from .logger import logger

if TYPE_CHECKING:
    from loomi.service import Service, ServiceABC
...
class ServiceRegistry(Generic[ServiceT]):
    ...
    def __init__(self) -> None:
        self._instances: dict[str, ServiceT] = {}
    ...
    def get_service(
        ...
        if service is not None:
            return self._narrow_to_service(service)
