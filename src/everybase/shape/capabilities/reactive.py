...
if TYPE_CHECKING:
    ...
    from everybase.shape.morphisms.reactive import (
        OnChangeOp,
        OnChildChangeOp,
        OnChildrenChangeOp,
...
class PrimitiveObservableBase:
    ...
    def on_change(self) -> OnPrimitiveChangeOp:
        from everybase.shape.morphisms.reactive import OnPrimitiveChangeOp
