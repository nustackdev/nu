...
async def run_all() -> list[TimingResult]:
    ...
    # nu-mem
    results.append(await _bench_dict("write nu-mem", d_write, d_write))
    results.append(await _bench_dict("read nu-mem", d_read, d_write))

    # nu-mem+inline
    results.append(await _bench_dict("write nu-mem+inline", di_write, di_write))
    results.append(await _bench_dict("read nu-mem+inline", di_read, di_write))
