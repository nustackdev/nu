...
class TestArithmeticExecution:
    ...
    def test_int_addition(self, ctx):
        """IntRef addition executes correctly: 5 + 3 = 8."""
        x = IntRef(5)
        y = IntRef(3)
    ...
    def test_int_subtraction(self, ctx):
        """IntRef subtraction executes correctly: 10 - 4 = 6."""
        x = IntRef(10)
        y = IntRef(4)
        result = (x - y).execute(ctx)
        assert result == 6
    ...
    def test_int_multiplication(self, ctx):
        """IntRef multiplication executes correctly: 6 * 7 = 42."""
        x = IntRef(6)
        result = (x * 7).execute(ctx)
        assert result == 42

    def test_int_division(self, ctx):
        """IntRef division executes correctly: 10 / 4 = 2.5."""
        x = IntRef(10)
        result = (x / 4).execute(ctx)
        assert result == 2.5

    def test_int_floor_division(self, ctx):
        """IntRef floor division executes correctly: 10 // 3 = 3."""
        x = IntRef(10)
        result = (x // 3).execute(ctx)
        assert result == 3

    def test_int_modulo(self, ctx):
        """IntRef modulo executes correctly: 10 % 3 = 1."""
        x = IntRef(10)
        result = (x % 3).execute(ctx)
        assert result == 1

    def test_int_power(self, ctx):
        """IntRef power executes correctly: 2 ** 10 = 1024."""
        x = IntRef(2)
        result = (x**10).execute(ctx)
        assert result == 1024

    def test_negation(self, ctx):
        """IntRef negation executes correctly: -42 = -42."""
        x = IntRef(42)
    ...
    def test_complex_expression(self, ctx):
        ...
        result = (((IntRef(10) - 2) * 3) + 4).execute(ctx)
        assert result == 28
...
class TestFloatExecution:
    ...
    def test_float_ensure_term(self, ctx):
...
class TestListExecution:
    ...
    def test_list_ensure_term(self, ctx):
