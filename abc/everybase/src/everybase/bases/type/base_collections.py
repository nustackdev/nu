...
if TYPE_CHECKING:
    ...
    from everybase.types import BoolType, DictType, FloatType, IntType, ListType, StrType
...
class LengthableBase:
    ...
    def len_(self) -> IntType:
        ...
        Returns:
            Length value
        """
        from everybase.ops import LenOp
        from everybase.types import IntType
...
class IndexableBase[KeyT, ResultValue]:
    ...
    def __getitem__(self, key: KeyT) -> ResultValue:
        ...
        from everybase.ops import AtOp
...
class SliceableBase[ResultT]:
    ...
    def slice_(
        ...
        Returns:
            Sliced result
        """
        from everybase.ops import SliceOp
...
class ContainableBase[ItemT]:
    ...
    def contains(self, item: ItemT) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everybase.ops import ContainsOp
        from everybase.types import BoolType
...
class IterableBase[ElementT, ResultT]:
    ...
    def map_[R](self, func: Callable[[ElementT], R]) -> ResultT:
        ...
        Returns:
            Mapped result
        """
        from everybase.ops import MapOp
    ...
    def filter_(self, predicate: Callable[[ElementT], bool]) -> ResultT:
        ...
        Returns:
            Filtered result
        """
        from everybase.ops import FilterOp
    ...
    def reduce_[R](self, func: Callable[[R, ElementT], R], initial: R) -> object:
        ...
        Returns:
            Reduced value
        """
        from everybase.ops import ReduceOp
        from everybase.types import AnyType
    ...
    def sum_(self) -> ResultT:
        ...
        Returns:
            Sum
        """
        from everybase.ops import SumOp
    ...
    def min_(self) -> ResultT:
        ...
        Returns:
            Minimum
        """
        from everybase.ops import MinOp
    ...
    def max_(self) -> ResultT:
        ...
        Returns:
            Maximum
        """
        from everybase.ops import MaxOp
    ...
    def any_(self) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everybase.ops import AnyOp
        from everybase.types import BoolType
    ...
    def all_(self) -> BoolType:
        ...
        Returns:
            Boolean result
        """
        from everybase.ops import AllOp
        from everybase.types import BoolType
...
class SequenceBase[ElementT, ResultT](
    ...
    def first(self) -> ResultT:
        ...
        Returns:
            First element
        """
        from everybase.ops import FirstOp
    ...
    def last(self) -> ResultT:
        ...
        Returns:
            Last element
        """
        from everybase.ops import LastOp
    ...
    def reversed_(self) -> ResultT:
        ...
        Returns:
            Reversed sequence
        """
        from everybase.ops import ReversedOp
    ...
    def sorted_(self, reverse: BoolArg = False) -> ResultT:
        ...
        Returns:
            Sorted sequence
        """
        from everybase.ops import SortedOp
    ...
    def join(self, separator: StrArg) -> StrType:
        ...
        Returns:
            Joined string
        """
        from everybase.ops import JoinOp
        from everybase.types import StrType
    ...
    def index(self, value: ElementT) -> IntType:
        ...
        Returns:
            Index
        """
        from everybase.ops import IndexOfOp
        from everybase.types import IntType
    ...
    def find_index(self, predicate: Callable[[ElementT], bool]) -> IntType:
        ...
        """
        from everybase.ops import FindIndexOp
        from everybase.types import IntType
    ...
    def count(self, value: ElementT) -> IntType:
        ...
        Returns:
            Count
        """
        from everybase.ops import CountOp
        from everybase.types import IntType
...
class MappingBase[KeyT, ValueT, ResultT](
    ...
    def keys_(self) -> ResultT:
        ...
        Returns:
            Keys sequence
        """
        from everybase.types.dict_ops import DictKeysOp
    ...
    def values_(self) -> ResultT:
        ...
        Returns:
            Values sequence
        """
        from everybase.types.dict_ops import DictValuesOp
    ...
    def items_(self) -> ResultT:
        ...
        Returns:
            Items sequence
        """
        from everybase.types.dict_ops import DictItemsOp
    ...
    def get_(self, key: KeyT, default: ValueT | None = None) -> ResultT:
        ...
        Returns:
            Value or default
        """
        from everybase.types.dict_ops import DictGetOp
...
class SetBase[ElementT, ResultT](
    ...
    def union(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Union set
        """
        from everybase.types.set_ops import UnionOp
    ...
    def intersection(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Intersection set
        """
        from everybase.types.set_ops import IntersectionOp
    ...
    def difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        Returns:
            Difference set
        """
        from everybase.types.set_ops import DifferenceOp
    ...
    def symmetric_difference(self, other: set[ElementT] | frozenset[ElementT] | Term) -> ResultT:
        ...
        """
        from everybase.types.set_ops import SymmetricDifferenceOp
    ...
    def issubset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everybase.types import BoolType
        from everybase.types.set_ops import IsSubsetOp
    ...
    def issuperset(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everybase.types import BoolType
        from everybase.types.set_ops import IsSupersetOp
    ...
    def isdisjoint(self, other: set[ElementT] | frozenset[ElementT] | Term) -> BoolType:
        ...
        """
        from everybase.types import BoolType
        from everybase.types.set_ops import IsDisjointOp
