...
from every import Type


if TYPE_CHECKING:
    from every import BoolArg, Sentinel, StrArg, Term
    from everybase.types import AnyType, BoolType, BytesType, FloatType, IntType, ListType, StrType
...
class BaseType[T](Type[T]):
    ...
    def is_empty(self) -> BoolType:
        ...
        """
        from everybase.ops import IsEmptyOp
    ...
    def is_invalid(self) -> BoolType:
        ...
        Returns:
            BoolType-like result
        """
        from everybase.ops import IsNaNOp
        from everybase.types import BoolType
    ...
    def ifelse[ElseT](
        ...
        """
        from everybase.ops import ConditionalOp
    ...
    def to_int(self) -> IntType:
        ...
        """
        from everybase.ops import ToIntOp
    ...
    def to_float(self) -> FloatType:
        ...
        """
        from everybase.ops import ToFloatOp
        from everybase.types import FloatType
    ...
    def to_bool(self) -> BoolType:
        ...
        """
        from everybase.ops import ToBoolOp
        from everybase.types import BoolType
    ...
    def to_str(self) -> StrType:
        ...
        """
        from everybase.ops import ToStrOp
    ...
    def to_bytes(self, encoding: StrArg = "utf-8") -> BytesType:
        ...
        """
        from everybase.ops import ToBytesOp
        from everybase.types import BytesType
    ...
    def to_list(self) -> ListType:
        ...
        """
        from everybase.ops import ToListOp
