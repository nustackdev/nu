...
class OrderableBase[OperandT]:
    ...
    def __gt__(self, other: OperandT) -> BoolType:
        ...
        from everybase.ops import GtOp
        from everybase.types import BoolType
    ...
    def __lt__(self, other: OperandT) -> BoolType:
        ...
        from everybase.ops import LtOp
        from everybase.types import BoolType
    ...
    def __ge__(self, other: OperandT) -> BoolType:
        ...
        from everybase.ops import GeOp
        from everybase.types import BoolType
    ...
    def __le__(self, other: OperandT) -> BoolType:
        ...
        from everybase.ops import LeOp
        from everybase.types import BoolType
...
class EqualableBase[OperandT]:
    ...
    def eq(self, other: OperandT) -> BoolType:
        ...
        Returns:
            Comparison result
        """
        from everybase.ops import EqOp
        from everybase.types import BoolType
    ...
    def ne(self, other: OperandT) -> BoolType:
        ...
        Returns:
            Comparison result
        """
        from everybase.ops import NeOp
        from everybase.types import BoolType
    ...
    def is_(self, other: OperandT) -> BoolType:
        ...
        Returns:
            IdCompOp expression
        """
        from everybase.ops import IdCompOp
        from everybase.types import BoolType
