...
class MutableSetRef[
    ...
    def add(self, value: ItemT) -> NoneType:
    ...
    def remove(self, value: ItemT) -> NoneType:
    ...
    def discard(self, value: ItemT) -> NoneType:
        ...
        Returns:
            NoneType (discard returns None after execution)
        """
        ...
