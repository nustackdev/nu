...
class TestWithChildren:
    ...
    def test_base_node_with_children_raises(self):
        node = Node()
        with pytest.raises(NotImplementedError, match="Node must implement with_children"):
            node.with_children(SimpleNode("x"))
