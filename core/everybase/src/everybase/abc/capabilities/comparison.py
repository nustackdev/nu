...
class EqualableBase[OperandT]:
    ...
    def is_(self, other: OperandT) -> BoolValue:
        ...
        from ..morphisms import IdCompOp
        from ..values import BoolValue
