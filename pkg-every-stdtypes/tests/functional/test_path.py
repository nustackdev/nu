...
from every_type import PathRef
...
class TestPathComponentAccess:
    ...
    def test_parent(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        path_shape.config_path.set(p).execute(ctx)
        result = path_shape.config_path.get().parent().execute(ctx)
    ...
    def test_parts(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        path_shape.config_path.set(p).execute(ctx)
        result = path_shape.config_path.get().parts().execute(ctx)
    ...
    def test_root(self, path_shape, ctx):
        ...
        p = Path("/home/user/file.txt")
        path_shape.config_path.set(p).execute(ctx)
        assert path_shape.config_path.get().root().execute(ctx) == "/"

    def test_anchor(self, path_shape, ctx):
        """Access path anchor."""
        p = Path("/home/user/file.txt")
        path_shape.config_path.set(p).execute(ctx)
        assert path_shape.config_path.get().anchor().execute(ctx) == "/"
...
class TestPathRefConstructors:
    ...
    def test_from_str(self, ctx):
        """Create from string."""
        result = PathRef.from_str("/home/user/file.txt").execute(ctx)
        assert result == Path("/home/user/file.txt")

    def test_cwd(self, ctx):
        """Create from current working directory."""
        result = PathRef.cwd().execute(ctx)
        assert result == Path.cwd()

    def test_home(self, ctx):
        """Create from home directory."""
        result = PathRef.home().execute(ctx)
...
class TestPathManipulation:
    ...
    def test_joinpath(self, path_shape, ctx):
        ...
        result = path_shape.data_dir.get().joinpath("subdir", "file.txt").execute(ctx)
...
class TestPathTests:
    ...
    def test_is_absolute_true(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().is_absolute().execute(ctx)
    ...
    def test_is_relative_to_true(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().is_relative_to("/home").execute(ctx)
        assert result is True
    ...
    def test_match_true(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().match("*.txt").execute(ctx)
        assert result is True
    ...
    def test_match_false(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().match("*.py").execute(ctx)
        assert result is False
...
class TestPathConversions:
    ...
    def test_as_posix(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().as_posix().execute(ctx)
        assert result == "/home/user/file.txt"
    ...
    def test_as_uri(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().as_uri().execute(ctx)
...
class TestPathEquality:
    ...
    def test_equals(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().eq(path_shape.data_dir.get()).execute(ctx)
        assert result is True
    ...
    def test_not_equals(self, path_shape, ctx):
        ...
        result = path_shape.config_path.get().ne(path_shape.data_dir.get()).execute(ctx)
        assert result is True
