...
first_tag = Team.tags[0]  # -> Str
meta_users = Team.meta["users"]  # -> Int
meta_count = Team.meta["users"] + 1  # -> Int
...
alice_age_plus1 = Team.members[42].age + 1  # -> Int

# Indexed shape list.
first_member = Team.ranks[0]  # -> nu.v.ShapeRef
first_age = Team.ranks[0].age  # -> nu.v.IntRef
first_greet = Team.ranks[0].name + ", welcome"  # -> Str
