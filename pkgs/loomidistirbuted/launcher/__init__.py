"""
LoomidDistributed Launcher Package - Infrastructure provisioning for distributed resources.
...
Launchers are regular Loomi resources that handle infrastructure lifecycle
...
Key Features:
    ...
    - Automatic provisioning and host startup via Loomi resource lifecycle
