...
from eb_flow import Const
from eb_flow_ext import Debug, Log
from everybase import Context


async def test_log_basic(caplog):
    with caplog.at_level(logging.INFO, logger="eb_flow_ext"):
...
async def test_log_level(caplog):
    with caplog.at_level(logging.DEBUG, logger="eb_flow_ext"):
