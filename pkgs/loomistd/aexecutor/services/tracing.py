...
class TracingService(AsyncService):
    ...
    async def post_initialize(self):
        ...
        if isinstance(trace_root, AsyncTreeDictProtocol):
        ...
        elif isinstance(trace_root, SyncTreeDictProtocol):
    ...
    async def start_execution(self, root_operation):  # noqa: C901
        ...
        async def register_operation(operation, parent_id=None):
            ...
            if isinstance(metadata_dict, AsyncTreeDictProtocol):
                await metadata_dict.set(op_id, value=metadata_value)
            elif isinstance(metadata_dict, SyncTreeDictProtocol):
        ...
        elif isinstance(exec_root, SyncTreeDictProtocol):
