...
from .._types import StateCallbackFn, StatePath, StateValue
...
class ObservableKVBackend:
    _storage: StorageServiceProtocol[StatePath, StateValue, Any, Any]
    _observer: ObserverServiceProtocol[StatePath, Any]

    def __init__(
        self,
        storage: StorageServiceProtocol[StatePath, StateValue, Any, Any],
        observer: ObserverServiceProtocol[StatePath, Any],
    ) -> None:
        """
    ...
    @property
    def storage(self) -> StorageServiceProtocol[StatePath, StateValue, Any, Any]:
        """
        Get storage backend.
    ...
    @property
    def observer(self) -> ObserverServiceProtocol[StatePath, Any]:
        """
    ...
    def get(self, key: StatePath) -> StateValue:
        """
        Get value at key.
    ...
    def set(self, key: StatePath, value: StateValue) -> None:
        """
    ...
    def delete(self, key: StatePath) -> None:
        """
    ...
    def exists(self, key: StatePath) -> bool:
        """
        Check if key exists.
    ...
    def list_keys(self, prefix: StatePath, depth: int = 1) -> Generator[StatePath, None, None]:
        """
...
class ObservableKVTransaction(SyncTransactionProtocol[StateValue]):
    ...
    modified_keys: set[StatePath] = field(default_factory=set)
...
if TYPE_CHECKING:
    _: type[SyncObservableStorageProtocol] = ObservableKVBackend
