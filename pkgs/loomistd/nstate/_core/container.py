...
from .._types import ContainerProtocol, ContainerStructure, NodeType, PathComponent
...
class ContainerNode(Node):
    ...
    def validate_child_path(self, key: PathComponent, node: Node, /) -> None:
        """
    ...
    def validate_flat_constraint(self, node: Node, /) -> None:
        """
    ...
    def get_child(self, key: PathComponent, /) -> Optional[Node]:
        """
    ...
    def _ensure_parent_exists(self, parent_path: StatePath, /) -> None:
        """
    ...
    def _create_child_node(self, path: StatePath, /) -> Node:
        """
    ...
    def _is_path_container(self, path: StatePath, /) -> bool:
        """
    ...
    def _remove_subtree(self, path: StatePath, /) -> None:
        """
