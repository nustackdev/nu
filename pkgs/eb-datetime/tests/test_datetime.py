...
from eb_datetime import DatetimeValue as DatetimeRef
from eb_datetime import DateValue as DateRef
from eb_datetime import TimedeltaValue as TimedeltaRef
