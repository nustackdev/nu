...
from everyterm.term import computed, literal
from everyterm.types import IntType, ListType, NoneType
...
if TYPE_CHECKING:
    ...
    from everyterm.types import BoolType, DictType, FloatType, StrType
