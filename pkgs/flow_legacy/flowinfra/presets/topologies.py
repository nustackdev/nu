...
# from everylink.spec import Spec, SpecBuilder

# from everyflow.microflow.microflow import MicroflowSpec, RuntimeSpec

# from .launcher import get_launcher_spec
# from .rpc import get_invisibles_specs
# from .state import get_rocksdb_state_spec, get_text_state_spec
...
#         app = get_enterprise_topology(MyMicroflowSpec)

#         # Production trading system
#         trading_app = get_enterprise_topology(
#             TradingMicroflowSpec,
#             worker_count=8,
...
#     base_state = get_rocksdb_state_spec(path=storage_path, name=f"{app_name}_state")

#     # 2. Create RPC specs for state service
#     state_client, state_server = get_invisibles_specs(
#         rpc_type="unix",
...
#     worker_client, worker_server = get_invisibles_specs(
#         rpc_type="unix",
...
#     base_state = get_text_state_spec(path=storage_path, name=f"{app_name}_state")
...
# def get_defiant_topology(app_spec: MicroflowSpec, **kwargs) -> Spec:
...
# def get_voyager_topology(app_spec: MicroflowSpec, **kwargs) -> Spec:
...
#     """
#     # 1. Create base state with file persistence
#     if state_type == "rocksdb":
#         state = get_rocksdb_state_spec(path=storage_path, name=f"{app_name}_state")
#     elif state_type == "text":
#         state = get_text_state_spec(path=storage_path, name=f"{app_name}_state")
#     else:
...
#     return main_app
"""Provides utility functions for creating common configurations."""
