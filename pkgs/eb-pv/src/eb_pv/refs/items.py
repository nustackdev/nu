...
Item refs combine ReactiveItemRef (eb_shape document model) with
...
from eb_shape import ReactiveItemRef, Slot
...
class ItemRef[T, ValueT: Value](
    ...
    Combines eb_shape document model (CRUD + observation) with
