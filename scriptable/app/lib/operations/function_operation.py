...
class FunctionOperation(Operation):
    ...
    def execute(self, service: "Service") -> None:
        ...
        try:
            ...
            service.state_set(self._state_key("start_time"), value="now")  # Use actual timestamp

            try:
                self.func()

                service.state_set(self._state_key("status"), value="completed")
                service.state_set(self._state_key("end_time"), value="now")  # Use actual timestamp
                ...
                service.state_set(self._state_key("error"), value=error_msg)
                service.state_set(self._state_key("end_time"), value="now")  # Use actual timestamp
