...
# ============================================================================
# UUID STORE AND LOAD TESTS
# ============================================================================


class TestUUIDStoreAndLoad:
    """Test storing and loading UUID values through storage."""

    async def test_store_and_load_uuid(self, uuid_shape, ctx):
