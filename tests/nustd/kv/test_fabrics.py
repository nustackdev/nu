...
# --- rdbpy is not needed to import nustd.kv ---------------------------------
...
_IMPORT_WITHOUT_RDBPY = (
    ...
    + """
import nustd.kv
import nustd.kv.fabrics
assert "rdbpy" not in sys.modules, "importing nustd.kv pulled in rdbpy"
print("OK")
"""
)
...
_SETUP_WITHOUT_RDBPY = (
    _NO_RDBPY_PRELUDE
    + """
from nustd.kv.fabrics import Codec, RocksDBStorage, binary_kwargs
from nu.lang import Context
...
def test_import_nu_kv_without_rdbpy():
    """``import nustd.kv`` must not require the RocksDB bindings."""
