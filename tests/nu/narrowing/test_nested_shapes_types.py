...
assert_type(User.profile.age + 1,                     IntForm)
assert_type(User.profile.age > 30,                    BoolForm)
assert_type("Hello " + User.profile.name,             StrForm)
assert_type(User.profile.name + "!",                  StrForm)
assert_type(User.profile.address.zipcode.code + 1,    IntForm)
assert_type(User.profile.address.zipcode.code == 90210, BoolForm)
...
assert_type(User.profile.name.is_empty(),               BoolForm)
assert_type(User.profile.address.zipcode.code.is_empty(), BoolForm)
