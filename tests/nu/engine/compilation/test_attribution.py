"""Unit tests for ``nu.engine.compilation.attribution``.
...
from nu.engine.compilation import Program, build_index, compile, sweep_attributes
from nu.engine.structure import Declared, Inherited, Synthesized
...
def test_an_unsupported_attribute_kind_raises_type_error(schema):
    from nu.engine.structure import Computed
