"""Unit tests for ``nu.engine.compilation.program``.
...
from nu.engine.compilation import Program, UnknownAttributeError, compile
from nu.engine.structure import Synthesized
